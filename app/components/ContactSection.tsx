...
const ContactSection = () => {
  return (
    <div className="w-full max-w-screen-xl h-auto bg-[#F4F4F4] flex flex-wrap items-center justify-between px-8 py-6 mt-28">
      <div className="flex items-center space-x-4 mb-6 sm:mb-0">
        <BsTrophy className="w-[52.77px] h-[60px] text-black" />
        <div>
          <h2
            className={`${poppins.className} font-semibold text-[20px] sm:text-[25px] text-gray-800`}
          >
            High Quality
          </h2>
          <p
