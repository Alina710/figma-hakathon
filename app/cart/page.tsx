        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between bg-white p-4 rounded-lg shadow-md mb-4">
            <div className="flex items-center space-x-4">
              <div className="w-20 h-20 sm:w-24 sm:h-24 bg-orange-200 rounded flex-shrink-0">
                <Image
                  src="/image 9.png"
            ...
            <div className="flex flex-col sm:flex-row items-center sm:space-x-3 mt-4 sm:mt-0">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between bg-white p-4 rounded-lg shadow-md">
            <div className="flex items-center space-x-4">
              <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gray-300 rounded flex-shrink-0">
                <Image
                  src="/frame.png"
                  alt="Library Stool Chair"
                  width={150}
        ...
        <div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="flex justify-between mb-6">
              <p className="text-xl mb-12">Total</p>
              <p className="text-xl d">$198.00</p>
            </div>
