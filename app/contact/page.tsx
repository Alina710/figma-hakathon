...
const Page = () => {
  return (
    <div className="max-w-screen-xl mx-auto mt-24 px-4 sm:px-6 ">
      {/* Heading */}
      <h1 className="font-bold text-4xl text-center sm:text-3xl ">
      ...
      <p className="text-[16px] text-[#9F9F9F] font-normal text-center mt-[30px] sm:w-full sm:text-sm">
        ...
        Drop Us An Email. <br /> Our Staff Always Be There To Help You Out. Do Not
        Hesitate!
      </p>

      {/* Grid Layout */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-[100px]">
